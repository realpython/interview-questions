...
class ParseCSVTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.soccer = ParseCSV(self.data)

    def test_csv_read_data_headers(self):
        self.assertEqual(
            self.soccer.read_data()[0],
            ['Team', 'Games', 'Wins', 'Losses', 'Draws', 'Goals', 'Goals Allowed', 'Points']
            )

    def test_csv_read_data_team_name(self):
        self.assertEqual(self.soccer.read_data()[1][0], 'Arsenal')

    def test_csv_read_data_points(self):
        self.assertEqual(self.soccer.read_data()[1][7], '87')

    def test_get_min_score_difference(self):
        self.assertEqual(self.soccer.get_min_score_difference(self.parsed_data), 1)

    def test_get_team(self):
        index_value = self.soccer.get_min_score_difference(self.parsed_data)
        self.assertEqual(self.soccer.get_team(index_value, self.parsed_data), 'Liverpool')
...
class SoccerParseCSVTest(unittest.TestCase):
    ...
    def test_get_min_score_difference(self):
        parsed_data = self.soccer.read_data()
        self.assertEqual(self.soccer.get_min_score_difference(parsed_data), 19)

    def test_get_team(self):
        parsed_data = self.soccer.read_data()
        index_value = self.soccer.get_min_score_difference(parsed_data)
        self.assertEqual(self.soccer.get_team(index_value, parsed_data), 'Leicester')
...
```bash
$ python parse_csv_test.py -v
test_csv_read_data_headers (__main__.SoccerParseCSVTest) ... FAIL
test_csv_read_data_points (__main__.SoccerParseCSVTest) ... FAIL
test_csv_read_data_team_name (__main__.SoccerParseCSVTest) ... FAIL
test_get_min_score_difference (__main__.SoccerParseCSVTest) ... ERROR
test_get_team (__main__.SoccerParseCSVTest) ... ERROR
```
...
```python
def setUp(self):
    self.soccer_data = 'soccer.csv'
    self.weather_data = 'weather.csv'
    self.soccer = ParseCSV(self.soccer_data)
...
def test_get_min_difference(self):
    soccer_parsed_data = self.soccer.read_data()
    self.assertEqual(self.soccer.get_min_score_difference(soccer_parsed_data), 19)
...
```bash
$ python parse_csv_test.py -v
test_csv_read_data_headers (__main__.SoccerParseCSVTest) ... ok
test_csv_read_random_data_points (__main__.SoccerParseCSVTest) ... ok
test_get_min_difference (__main__.SoccerParseCSVTest) ... FAIL
```
...
def test_get_min_difference(self):
    soccer_parsed_data = self.soccer.read_data()
    self.assertEqual(self.soccer.get_min_difference(soccer_parsed_data, 5, 6), 19)
    weather_parsed_data = self.weather.read_data()
...
test_csv_read_data_headers (__main__.SoccerParseCSVTest) ... ok
test_csv_read_random_data_points (__main__.SoccerParseCSVTest) ... ok
test_get_min_difference (__main__.SoccerParseCSVTest) ... ok
...
def test_get_name(self):
    soccer_parsed_data = self.soccer.read_data()
    index_value = self.soccer.get_min_difference(soccer_parsed_data, 5, 6)
    self.assertEqual(self.soccer.get_team(index_value, soccer_parsed_data), 'Leicester')
    weather_parsed_data = self.weather.read_data()
...
test_csv_read_random_data_points (__main__.SoccerParseCSVTest) ... ok
test_get_min_difference (__main__.SoccerParseCSVTest) ... ok
test_get_name (__main__.SoccerParseCSVTest) ... ok
